import{c as h,a as o,b as U,d as R,e as V,i as W,f as Q,g as L,u as X,h as J,j as N,k as I,l as Y,m as Z,n as ee,o as r,p as oe,q as T,r as O,s as y,w,t as B,v as E,x as F,F as G,y as H,_ as te}from"./index-c2c9ea37.js";import{g as ne}from"./get-slot-1efb97e5.js";function q(n,b="default",a=[]){const{children:s}=n;if(s!==null&&typeof s=="object"&&!Array.isArray(s)){const d=s[b];if(typeof d=="function")return d()}return a}const K="DESCRIPTION_ITEM_FLAG";function re(n){return typeof n=="object"&&n&&!Array.isArray(n)?n.type&&n.type[K]:!1}const ie=h([o("descriptions",{fontSize:"var(--n-font-size)"},[o("descriptions-separator",`
